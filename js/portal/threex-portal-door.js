...
THREEx.Portal360.prototype._buildOutsideMesh = function(texture360, doorWidth, doorHeight){
	...
	//////////////////////////////////////////////////////////////////////////////
	// add 360 texture
	var radius360Sphere = 1.3;

	// build half sphere geometry
	var geometry = new THREE.SphereGeometry( radius360Sphere, 0,32 , Math.PI, Math.PI, 0, Math.PI).rotateZ(Math.PI);
	// fix UVs
...
THREEx.Portal360.prototype.update = function () {
	// No need for this function as there's no inside mesh to check
}
